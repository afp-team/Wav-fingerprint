...
class wynik():
    def srednia(self,ilosc_probek,lista_1,lista_2,lista_3,lista_4,lista_5,lista_6,lista_7,lista_8,lista_9,lista_10,lista_11,lista_12,lista_13,lista_14):
        if ilosc_probek > 2048 or ilosc_probek < 2048:
            ...
            print("Róźnica12 Euklides dis 1   : ", lista_13)
            print("Róźnica12 Euklides dis 2   : ", lista_14)
            ...
            lista_suma = [srednia_1, srednia_2, srednia_3, srednia_4, srednia_5, srednia_6, srednia_7,
                          srednia_8, srednia_9, srednia_10, srednia_11, srednia_12,srednia_13,srednia_14]
